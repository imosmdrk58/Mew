          ...
          <Breadcrumb className="flex flex-wrap">
            <BreadcrumbList>
              <BreadcrumbItem className="text-white">
                <BreadcrumbLink className="hover:text-[#FFD700]" href="/">
                  Home
                </BreadcrumbLink>
              </BreadcrumbItem>
              <BreadcrumbSeparator />
              <BreadcrumbItem className="text-[#ddd]">
                <BreadcrumbLink
                  ...
                  href={`/detailpage/${params.mangaId}`}
                >
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem className="text-[#ddd]">
                <BreadcrumbLink className="hover:text-[#FFD700]" href="/filter">
                  Chapter 75
                </BreadcrumbLink>
              </BreadcrumbItem>
            </BreadcrumbList>
